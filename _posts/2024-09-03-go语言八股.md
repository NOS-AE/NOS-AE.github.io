...
- 主动调度：用户代码调用`runtime.GoSched`，当前g进入`_Grunnable`状态
- 被动调度：用户代码进行了阻塞操作`runtime.gopark`，当前g进入`_Gwaiting`状态
- 正常调度：正常结束，当前g进入`_Gdead`
- 抢占调度：当用户代码发起系统调用并且达到一定时长，由monitor g异步发起，将p和m解除绑定

## 🔗

[ https://www.bilibili.com/video/BV1hv411x7we/?p=4&share_source=copy_web&vd_source=c0d41b92058c38bc23233feb8c73c581]( https://www.bilibili.com/video/BV1hv411x7we/?p=4&share_source=copy_web&vd_source=c0d41b92058c38bc23233feb8c73c581)
